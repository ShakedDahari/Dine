...
export default function Login(props) {
  ...
  const { setExpoPushToken, userName, password, setUserName, setPassword, setLoginUser, checkLoginUser, checkLoginRestaurant, isRestaurantOwner, setIsRestaurantOwner, saveUserToken, saveRestaurantToken  } = useContext(ContextPage);
